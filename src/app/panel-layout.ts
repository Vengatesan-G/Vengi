      ...
      <div class="header">
        <div class="header-left">
          <div class="variant-switcher">${(() => {
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('itqa', 'https://itqa.worldmonitor.app')}"
               class="variant-option ${SITE_VARIANT === 'itqa' ? 'active' : ''}"
               data-variant="itqa"
               ${vTarget('itqa')}
               title="${t('header.itqa')}${SITE_VARIANT === 'itqa' ? ` ${t('common.currentVariant')}` : ''}">
              <span class="variant-icon">🔬</span>
              <span class="variant-label">${t('header.itqa')}</span>
            </a>
