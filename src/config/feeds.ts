...
const ITQA_FEEDS: Record<string, Feed[]> = {
  ai: [
    ...
    { name: 'OpenAI Blog', url: rss('https://openai.com/blog/rss') },
    { name: 'ArXiv AI', url: rss('https://feeds.arxiv.org/rss/cs.AI') },
    { name: 'MIT Tech Review AI', url: rss('https://www.technologyreview.com/topic/artificial-intelligence/feed/') },
    { name: 'Towards Data Science AI', url: rss('https://towardsdatascience.com/feed/tag/artificial-intelligence') },
    { name: 'VentureBeat AI', url: rss('https://venturebeat.com/category/ai/feed/') },
    { name: 'The Verge AI', url: rss('https://www.theverge.com/rss/ai-artificial-intelligence/index.xml') },
  ],
  qa: [
  ...
  testing: [
    ...
    { name: 'Applitools Blog', url: rss('https://www.applitools.com/blog/feed/') },
  ...
  tech: [
    ...
    { name: 'TechCrunch AI', url: rss('https://techcrunch.com/tag/artificial-intelligence/feed/') },
    { name: 'TechCrunch', url: rss('https://techcrunch.com/feed/') },
    { name: 'The Verge', url: rss('https://www.theverge.com/rss/index.xml') },
    { name: 'Ars Technica', url: rss('https://feeds.arstechnica.com/arstechnica/technology-lab') },
    { name: 'MIT Tech Review', url: rss('https://www.technologyreview.com/feed/') },
...
export const SOURCE_REGION_MAP: Record<string, { labelKey: string; feedKeys: string[] }> = {
  ...
  // IT QA variant regions
  itqaAi: { labelKey: 'header.sourceRegionItqaAi', feedKeys: ['ai'] },
  itqaQaTesting: { labelKey: 'header.sourceRegionItqaQaTesting', feedKeys: ['qa', 'testing'] },
  itqaTech: { labelKey: 'header.sourceRegionItqaTech', feedKeys: ['tech'] },
