...
const VARIANT_META: Record<string, {
  ...
  itqa: {
    title: 'IT QA Monitor - AI, QA & Testing Intelligence Dashboard',
    description: 'Real-time monitoring of AI developments, quality assurance updates, and new testing methodologies. Track QA tools, AI testing news, and software testing best practices.',
    keywords: 'IT QA, quality assurance, software testing, AI testing, QA tools, testing methodologies, test automation, QA news, AI developments, QA monitor, testing updates',
    url: 'https://itqa.worldmonitor.app/',
    siteName: 'IT QA Monitor',
    shortName: 'ITQAMonitor',
    subject: 'AI, Quality Assurance, and Testing Intelligence',
    classification: 'IT QA Dashboard, Testing News, AI QA Tracker',
    categories: ['news', 'business'],
    features: [
